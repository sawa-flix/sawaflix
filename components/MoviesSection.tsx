...
const movies = [
    ...
    },
    {
        ...
        image: "https://images.unsplash.com/photo-1542204165-65bf26472b9b?w=800&auto=format&fit=crop",
        year: "2024"
    },
    {
        id: 3,
        title: "Rhythm of Art",
        category: "Musical",
        image: "https://images.unsplash.com/photo-1518929458119-e5bf444c30f4?w=800&auto=format&fit=crop",
        year: "2022"
    }
];
...
export default function MoviesSection() {
    return (
        <section className="py-20 bg-[#0B0E14]" id="movies">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {movies.map((movie, index) => (
                        <Link href="/dashboard/movie" key={movie.id} className="block group relative cursor-pointer">
                            <motion.div
