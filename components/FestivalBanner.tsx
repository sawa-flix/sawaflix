...
export default function FestivalBanner() {
    return (
        <section className="py-10 bg-[#0B0E14]">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                >
                    ...
                    <div className="relative z-10 max-w-3xl">
                        <span className="text-red-400 font-semibold tracking-widest uppercase text-sm mb-4 block">Coming Soon</span>
                        <h2 className="text-3xl md:text-5xl font-bold text-white mb-6 font-serif">
                            Maaval Heritage Festival
                        </h2>
                        <p className="text-gray-300 text-lg mb-8 leading-relaxed">
                            Join us in celebrating the diverse culture of the Sawa people through music, dance, digital arts, and culinary traditions.
                            An immersive experience awaiting you.
                        </p>
