...
export default function GenreSection() {
    return (
        <section className="py-20 bg-[#0B0E14]" id="music">
                        ...
                        >
                            ...
                            >
                                ...
                                <div className="absolute inset-0 flex flex-col items-center justify-center text-white">
                                    <div className={`p-3 rounded-full bg-gradient-to-br ${genre.color} mb-2 shadow-lg`}>
                                        {genre.icon}
                                    </div>
                                    <h3 className="font-bold text-lg">{genre.name}</h3>
                                    <span className="text-xs text-gray-300 opacity-0 group-hover:opacity-100 transition-opacity">Explore</span>
                                </div>
                            </motion.div>
                        </Link>
                    ))}
