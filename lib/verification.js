...
export async function uploadFile(file, category) {
  ...
  if (category === 'profile_image') fieldName = 'profile_image';
  if (category === 'cover_image') fieldName = 'cover_image';
  ...
  if (!extractedUrl && result.data && result.data.form_data && result.data.form_data.documents) {
      if (category === 'selfie') extractedUrl = result.data.form_data.documents.selfie_url;
      else if (category === 'national_id' || category === 'id') extractedUrl = result.data.form_data.documents.national_id_url || result.data.form_data.documents.id_url;
      else if (category === 'endorsement_letter' || category === 'endorsements') extractedUrl = result.data.form_data.documents.endorsement_letter_url || result.data.form_data.documents.endorsements_url;
      ...
      else if (category === 'profile_image') extractedUrl = result.data.form_data.documents.profile_image_url || result.data.form_data.documents.profile_image;
      else if (category === 'cover_image') extractedUrl = result.data.form_data.documents.cover_image_url || result.data.form_data.documents.cover_image;
